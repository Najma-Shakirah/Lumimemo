...
class AppTheme {
  ...
  static const Color primary = Color.fromARGB(255, 163, 65, 163);       // warm amber
  static const Color primaryDark = Color.fromARGB(255, 98, 4, 123);
  static const Color background = Color.fromARGB(255, 132, 50, 150);    // deep navy-black
